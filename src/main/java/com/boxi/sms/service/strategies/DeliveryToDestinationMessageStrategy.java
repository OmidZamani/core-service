...
@Component
public class DeliveryToDestinationMessageStrategy implements SendMessageStrategy {


    private static PropConf propConfig;
    private final String KEY="deliveredToDestinationSMS";

    @Autowired
    public DeliveryToDestinationMessageStrategy(PropConf propConfig) {
        DeliveryToDestinationMessageStrategy.propConfig = propConfig;
    }
