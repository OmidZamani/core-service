...
@Component
public class DeliveryHubReceiveMessageStrategy implements SendMessageStrategy {




    private static PropConf propConfig;
    private final String KEY="deliveryHubReceiveSMS";

    @Autowired
    public DeliveryHubReceiveMessageStrategy(PropConf propConfig) {
        DeliveryHubReceiveMessageStrategy.propConfig = propConfig;
    }
