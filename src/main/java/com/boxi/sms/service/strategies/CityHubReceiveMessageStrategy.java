...
@Component
public class CityHubReceiveMessageStrategy implements SendMessageStrategy {



    private static PropConf propConfig;
    private final String KEY="cityHubReceiveSMS";

    @Autowired
    public CityHubReceiveMessageStrategy(PropConf propConfig) {
        CityHubReceiveMessageStrategy.propConfig = propConfig;
    }
