...
@Component
public class StaffHasConsignmenetMessageStrategy implements SendMessageStrategy {


    private static PropConf propConfig;
    private final String KEY="staffHasConsignmentSMS";

    @Autowired
    public StaffHasConsignmenetMessageStrategy(PropConf propConfig) {
        StaffHasConsignmenetMessageStrategy.propConfig = propConfig;
    }
