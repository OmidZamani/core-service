...
@Component
public class ReturnSmsMessageStrategy implements SendMessageStrategy {


    private static PropConf propConfig;
    private final String KEY="returnSMS";

    @Autowired
    public ReturnSmsMessageStrategy(PropConf propConfig) {
        ReturnSmsMessageStrategy.propConfig = propConfig;
    }
