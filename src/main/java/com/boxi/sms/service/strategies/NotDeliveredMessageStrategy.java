...
@Component
public class NotDeliveredMessageStrategy implements SendMessageStrategy {

    private static PropConf propConfig;
    private final String KEY="notDeliveredSMS";

    @Autowired
    public NotDeliveredMessageStrategy(PropConf propConfig) {
        NotDeliveredMessageStrategy.propConfig = propConfig;
    }
