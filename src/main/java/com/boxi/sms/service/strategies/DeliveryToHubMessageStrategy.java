...
@Component
public class DeliveryToHubMessageStrategy implements SendMessageStrategy {

    private static PropConf propConfig;
    private final String KEY="deliveredToHubSMS";

    @Autowired
    public DeliveryToHubMessageStrategy(PropConf propConfig) {
        DeliveryToHubMessageStrategy.propConfig = propConfig;
    }
