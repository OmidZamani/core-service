...
@Component
public class DeliveryTimeMessageStrategy implements SendMessageStrategy {

    private static PropConf propConfig;
    private final String KEY="deliveryTimeSMS";

    @Autowired
    public DeliveryTimeMessageStrategy(PropConf propConfig) {
        DeliveryTimeMessageStrategy.propConfig = propConfig;
    }
