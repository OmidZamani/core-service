...
@Component
public class FailedPickupMessageStrategy implements SendMessageStrategy {



    private static PropConf propConfig;
    private final String KEY="failedPickupSMS";

    @Autowired
    public FailedPickupMessageStrategy(PropConf propConfig) {
        FailedPickupMessageStrategy.propConfig = propConfig;
    }
