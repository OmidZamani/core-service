...
@Component
public class SecondaryDestinationDeliveredMessageStrategy implements SendMessageStrategy {


    private static PropConf propConfig;
    private final String KEY="secondaryDestinationSMS";

    @Autowired
    public SecondaryDestinationDeliveredMessageStrategy(PropConf propConfig) {
        SecondaryDestinationDeliveredMessageStrategy.propConfig = propConfig;
    }
