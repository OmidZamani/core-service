...
@Component
public class NotifyPickupFromHubMessageStrategy implements SendMessageStrategy {


    private static PropConf propConfig;
    private final String KEY="notifyPickupFromHubSMS";

    @Autowired
    public NotifyPickupFromHubMessageStrategy(PropConf propConfig) {
        NotifyPickupFromHubMessageStrategy.propConfig = propConfig;
    }
