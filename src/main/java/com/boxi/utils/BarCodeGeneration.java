...
import com.boxi.transport.payload.dto.BarCodeDto;
...
public class BarCodeGeneration {
    ...
    public static BufferedImage generateCode128BarcodeImage(BarCodeDto barCodeDto) {
        Code128Bean barcodeGenerator = new Code128Bean();
        BitmapCanvasProvider canvas = new BitmapCanvasProvider(160, BufferedImage.TYPE_BYTE_BINARY, false, 0);

        barcodeGenerator.generateBarcode(canvas, barCodeDto.getCode());
        return canvas.getBufferedImage();
    }
