...
public class FindOS {
    ...
    public static String getBoxiPath(){
        String path=System.getProperty("user.home");
        folderCreateIfNotExist(path+File.separator+".boxi");
        return path+File.separator+".boxi";
    ...
    public static String getFileDirectory(){
        String path = getHomeDirectory() + File.separator + ".boxi";
